<div align="center">
  <img src=".assets/img/logo.svg#gh-dark-mode-only" alt="Repo CLI" width="200" />
  <img src=".assets/img/logo.svg#gh-light-mode-only" alt="Repo CLI" width="200" />
</div>

> The was inspired from of the GitHub `gh` CLI.
